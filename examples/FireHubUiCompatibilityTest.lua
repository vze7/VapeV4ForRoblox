...
Grab:AddSection()
Grab:AddLabel('Labels render in native Vape modules.')
Grab:AddParagraph('Status', 'Safe compatibility test: no gameplay changes.', 'Left')
Grab:AddButton({Name = 'Notification', Callback = function() notify('Fire Hub', 'Button works') end})
...
Auras:AddPbind({Name = 'Position', DefaultX = '1', DefaultY = '2', DefaultZ = '3'}):toggle()
...
Bind:AddSection()
Bind:AddBind({Name = 'Test bind', Default = Enum.KeyCode.K, Callback = function() notify('Bind', 'Bind works') end})
